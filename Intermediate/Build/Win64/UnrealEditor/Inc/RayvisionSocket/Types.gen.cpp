...
class UScriptStruct* FJoyMoveMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_JoyMoveMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FJoyMoveMessage, Z_Construct_UPackage__Script_RayvisionSocket(), TEXT("JoyMoveMessage"));
	}
...
template<> RAYVISIONSOCKET_API UScriptStruct* StaticStruct<FJoyMoveMessage>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_EventName = { "EventName", nullptr, (EPropertyFlags)0x0010000001000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FJoyMoveMessage, EventName), METADATA_PARAMS(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_EventName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_EventName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_X = { "X", nullptr, (EPropertyFlags)0x0010000001000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FJoyMoveMessage, X), METADATA_PARAMS(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_X_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_X_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_Y = { "Y", nullptr, (EPropertyFlags)0x0010000001000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FJoyMoveMessage, Y), METADATA_PARAMS(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_Y_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewProp_Y_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_RayvisionSocket_Source_RayvisionSocket_Public_Types_h_Statics::ScriptStructInfo[] = {
		{ FJoyMoveMessage::StaticStruct, Z_Construct_UScriptStruct_FJoyMoveMessage_Statics::NewStructOps, TEXT("JoyMoveMessage"), &Z_Registration_Info_UScriptStruct_JoyMoveMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FJoyMoveMessage), 893701931U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_RayvisionSocket_Source_RayvisionSocket_Public_Types_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTypes, UTypes::StaticClass, TEXT("UTypes"), &Z_Registration_Info_UClass_UTypes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTypes), 2092963897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_RayvisionSocket_Source_RayvisionSocket_Public_Types_h_4039779895(TEXT("/Script/RayvisionSocket"),
